# BE-P2-004: AI Tool — search_files
...
- **Do NOT wait for BE-P2-001** — use `fast-glob` directly with a fixture project
- Export tool definition + handler function independently
- Tool handler loop (BE-P2-006) will mock this with canned search results until integration
