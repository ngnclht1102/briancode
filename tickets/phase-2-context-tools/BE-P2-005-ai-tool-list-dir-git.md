# BE-P2-005: AI Tools — list_directory & read_git_diff
...
- Develop each tool as standalone function, test independently
- `list_directory`: test against fixture dir
- `read_git_diff`: test against a real git repo (the project itself)
- Others mock these with canned responses until integration
