# BE-P2-001: Workspace File Tree Scanning
...
- Develop as standalone module, test against a local fixture directory
- Export interface that other modules can mock: `getFileTree(): FileNode[]`
- Others mock this with a hardcoded file tree array
