# BE-P3-003: Plan Mode WebSocket Integration

**Phase:** 3 - Plan Mode
**Assignee:** BE (Backend Dev)
**Priority:** Critical
**Dependencies:** TL-P3-001, BE-P2-006
...
- **Do NOT wait for TL-P3-001 (plan prompt)**
- Mock plan parser: return a hardcoded plan from any AI response
- Focus on WebSocket event flow: detect plan → send `plan:steps` → handle `plan:approve`/`plan:edit`/`plan:execute`
- Real plan parsing wired during TL-P3-008 (integration)
